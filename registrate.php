...
<div class="login-form">
			...
			<form>
				...
				<div class="login-ic">
					<i class="icon"></i>
					<input type="password"  value="Confirma tu contraseña" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contraseña';}"/>
					<div class="clear"> </div>
				</div>
				...
				<p ><a style="color:rgb(255, 255, 255)"  href="inicio_de_sesion.html">Inicia sesión</a></p>
