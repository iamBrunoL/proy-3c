...
<div class="container">
  ...
  <a href="cambiosNoticias.php" class="list-group-item list-group-item-action">Modificar usuarios</a>
  <a href="eliminar_usuarios.php" class="list-group-item list-group-item-action">Eliminar usuarios</a>
    ...
    <div class="container text-center">
        <h2 style="color:rgb(255, 255, 255)">Bienvenidio a la aplicación de gestión de usuarios</h2>
    </div>
