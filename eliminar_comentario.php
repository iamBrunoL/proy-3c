...
<?php
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"
        method="POST">
            <label for="numeroregistro">Ingresa la numeroregistro del comentario a borrar</label>
            <input type="text" name="numeroregistro" id="numeroregistro" value="<?php echo $numeroregistro;?>">
            <input type="submit" name="buscarnumeroregistro" value="Buscar numeroregistro">
           <br><br>
